...
export default function Home_Xl() {
    return (
        <div>
            ...
            <Row justify={"space-around"} className="padding-top-20 padding-bottom-20">
                <Col span={11} className="Box-Design">
                    <p className="textStyle-home-xl">

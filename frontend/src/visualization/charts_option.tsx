...
// Define a function that generates options for a 2D scatter plot
export function optionVizScatter2D(data: [number, number][], fsize: number, algoName: string, n_component: number, includeToolbox: boolean) : EChartsOption {
    ...
    const option: EChartsOption = {
        ...
        series: [{
            ...
            symbolSize: fsize,
            // Transform the data to a format expected by ECharts
...
export function optionVizScatter3D(data: [number, number, number][], fsize: number, algoName: string, n_component: number, includeToolbox: boolean) : EChartsOption {
